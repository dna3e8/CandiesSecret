...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftContent" Runat="Server">
    ...
    <asp:Image ID="Image2" runat="server" AlternateText="TrufCandiefles"  CssClass="imageleft"  ImageUrl="~/Images/Candie.png" />
    <p >
    ...
    <asp:Image ID="Image1" runat="server" AlternateText="TrufCandiefles"  CssClass="imageright" ImageUrl="~/Images/Gloria.png" />
    <p>
    ...
    <asp:Image ID="Image3" runat="server" AlternateText="TrufCandiefles"  CssClass="imageleft" ImageUrl="~/Images/Lance.png" />
    <p>
